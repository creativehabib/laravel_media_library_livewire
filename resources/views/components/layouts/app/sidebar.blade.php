...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        ...
        <script>
            ...
            // মিডিয়া পিকার → CKEditor 4-এর জন্য wrapper
            function openCkeditorImagePicker(editorId) {
                openMediaManagerForEditor(function (url, data) {
                    // চাইলে replace logic করো: সিলেক্টেড ইমেজ থাকলে সেটা change করো
                    ...
                    if (element && element.getName && element.getName() === 'img') {
                        // 🔄 যদি কার্সর আগে থেকে img-এর উপর থাকে → src replace
                        element.setAttribute('src', url);
                        if (data?.name) {
                            element.setAttribute('alt', data.name);
                        }
                    } else {
                        // ➕ না থাকলে নতুন ইমেজ ইনসার্ট
                        editor.insertHtml(
